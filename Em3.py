...
def helptexttospeech():
    helpTextToSpeech =   """💠คำสั่งเลียนแบบMJ&BotSelf💠
🌏 เลียนแบบ on/off 
🌏 เลียนแบบ 
🌏 เพิ่มเลียนแบบ (@) 
🌏 ลบเลียนแบบ (@)"""
...
def helplanguange():
    helpLanguange =    """💨คำสั่งล่องหนMJ&BOT💨
⚓!แทค
⚓!มิด
⚓!คท"""
...
#==============================================================================#
                    ...
                    try:
                        ret_ = "╔════[  เชคการตั้งค่า MJ&Bot Self ]═════┓"
...
#==============================================================================#
                    ...
                    line.sendMessage(msg.to,"เชิญโทรสำเร็จแล้วครับ")	
                elif text.lower() == 'แทก':
                            if msg.toType == 0:
                                sendMention(to, to, "", "")
                            elif msg.toType == 2:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["speed","sp","Speed","สปีด","!speed","/speed"]:
                    line.sendText(msg.to,"แรงขนาดนี้ เจนี้ไลค์เลย👍")
                ...
                if msg.text in ["555","5555","55555","55+","55++","555+","555++","5555+","5555++"]:
                    line.sendText(msg.to,"กูว่าอาการหนักนะเนี๊ยะ!!. อิอิ😝😝")				
                ...
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        ...
                        if Name in RfuCctv['sidermem'][op.param1]:
                            ...
                            pref=['สวัสดีคนอ่าน➠ @','ตร๊ะ!..เอ๋!!..😝➠ @','แอบอ่านอยู่ได้เดียวจิ้มตาบอด➠ @','เห็นนะ อิอิ..😝➠ @','แอบทำมัย? มาคุยกันหน่อย➠ @','แอบแฟนเล่นหราา💨➠ @','รู้นะว่าคัยอ่าน👉➠ @','เล่นซ่อนแอบหรอคร้าบบ👻➠ @','มาคุยกับเค้าหน่อย➠ @','นั่นแน่ แอบหราาา➠ @','จร๊ะ!!..เอ๋!..➠ @']
