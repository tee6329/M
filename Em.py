...
settings = {
    ...
    "man2":"ตั้งข้อความ",
    "man3":"ตั้งข้อความ",
    "message":"บัญชีนี้ได้การป้องกัน👮โดย เจ Bot Self ระบบได้ทำการบล็อคคุณอัตโนมัติ\nติดต่อเจได้ที่ mj.ktc",
...
mulai = time.time() 
dangerMessage = ["เจเสียใจด้วยครับ","โชคดีครับ","ชีวิตยังมีงวดหน้าเสมอ",".winebot",".kickall","mayhem","kick on","makasih :d","!kickall","nuke","บิน",".???","Kickall","บินไปดิ","Kickword","kickword","!kickword","/kickall"]
dangerMessage2 = ["ว่างัยจ๊ะทิรักของเจ 5555","คร้าบบ","ว่างัยน่ะ!!.. รักเจหรออ อิอิ","ว่างัยเอ๋ยย เจรอฟังอยู่","เจมาแล้วคร้าบบ","แอบรักเจอยู่หราาา","แอบชอบเจหราา","รักเจหรอ","คิดถึงเจมากเลยหรอ"]
...
def listgrup():
    listGrup =  """🔧คำสั่งตั้งค่า เจBotSelf🔧
...
🏁ปิดออก ➠ ปิดออกแชทรวม
🏁เปิดอ่าน ➠ เปิดอ่านออโต้
🏁ปิดอ่าน ➠ ปิดอ่านออโต้
🏁ปิดแทค ➠ ตอบกลับคนแทค
🏁ปิดแทค ➠ ปิดตอบกลับคนแทค
🏁เปิดแทค2 ➠ ส่งรูปคนแทคเรา
🏁ปิดแทค2 ➠ ปิดส่งรูปคนแทค
🏁เปิดแทค3 ➠ ตอบกลับสติ๊กเกอร์
🏁เปิดเชคติ้ก ➠ เปิดดูลิ้งสติ้กเก้อ
🏁ปิดเชคติ้ก ➠ ปิดดูลิ้งสติ้กเก้อ
🏁เปิดดูคนอ่าน ➠ จับคนแอบอ่าน
🏁ปิดดูคนอ่าน ➠ ปิดจับคนแอบอ่าน
🏁เปิดข้อมูล ➠ เปิดอ่านMid  
🏁ปิดข้อมูล ➠ ปิดอ่านMid  
🏁เปิดลิ้ง ➠ เปิดดูลิ้งโพส
🏁ปิดลิ้ง ➠ ปิดดูลิ้งโพส
🏁ตั้งเข้า:👉 ตั้งข้อความต้อนรับ
🏁ตั้งออก:👉 ตั้งข้อความลาคนออก
🏁ตั้งแทค:👉 ตั้งข้อความถึงคนแทค
🏁เช็คเข้า 👉 เช็คต้อนรับคนเข้า
🏁เช็คออก 👉 เช็คบอกลาคนออก
🏁เช็คแทค 👉 เช็คข้อความแทค
🏁.บอทยก 👉 ยกเลิกค้างเชิญทั้งหมด
🏁ต้อนรับ  ON👉 เปิดต้อนรับกับออก
🏁ต้อนรับ  OFF👉 ปิดต้อนรับกับออก"""
    return listGrup

def socmedia():
    socMedia = """🌟คำสั่งแทค เจBotSelf🌟
🔴คท @ ➠ แทคคนที่จะเอาคท
🔴มิด @  ➠ ลงmidคนอื่น
🔴ชื่อ @ ➠ ลงชื่อคนอื่น
🔴ตัส @ ➠ ลงตัสคนอื่น
...
🕑 ดูเวลา 👉 เช็ควันเวลา
🚷 สแปม  👉 ปล่อยไวรัส
🚫 ปิดบอท 👉 ปิดการทำงานบอท
🔄 รีบอท  👉 ล๊อกอินบอทไหม่
🔄 ออน  👉 ออนบอท
🔄 แอด  👉 แอดมินกลุ่ม
🔄 บอท  👉  ข้อมูลผู้สร้างบอท
🔄 /ลบรัน  👉 ลบรัน
🔵 ผส  👉 ผู้สร้างบอท
...
def helpkicker():
    helpKicker = """🔶คำสั่งค้นหา เจBotSelf🔶
🔊 พูด ข้อความ ➠ สั่งสิริพูด
🔊 ยูทูป ข้อความ ➠ ค้นหาในยูทูป
🔊 เขียน ข้อความ ➠ เขียน
🔊 instagram ➠ ใส่ชื่อค้นหา
🔊 รูปมา ข้อความ ➠ ส่งรูป
🔊 กาตูน ข้อความ ➠ ลงรูป"""
    return helpKicker
    
def helpsetting():
    helpSetting = """⚓คำสั่งกลุ่ม เจBotSelf⚓
♦ กลุ่ม ➠ ข้อมูลกลุ่ม
♦ ไอดีกลุ่ม ➠ไอดีห้อง
♦ ชื่อกลุ่ม ➠ ชื่อห้อง
...
⏰ ปิดเวลา ➠ ปิดเวลา
⏰ รีเวลา ➠ ลบเวลาคนอ่าน
🔐 bo ➠ รายชื่อที่เราบ๊อคเพื่อน
📢 #ประกาศ: ข้อความ ➠ ส่งแชททุกห้อง"""
    return helpSetting

def helptexttospeech():
    helpTextToSpeech =   """🔰คำสั่งเลียนแบบเจBotSelf🔰
🌏 เลียนแบบ on/off 
🌏 เลียนแบบ 
🌏 เพิ่มเลียนแบบ (@) 
🌏 ลบเลียนแบบ (@)"""
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    if targets == []:
                        line.sendMessage(to, "💨ไม่มีคนใส่ร่องหนในกลุ่มนี้ครับ✅")
                    else:
                        mc = ""
                    ...
                    for g in gs.members:
                        if g.displayName in "":
                            lists.append(g.mid)
                    if lists == []:
                        line.sendMessage(to, "💠ไม่มี MID คนใส่ร่องหนครับ✅")
                    else:
                        mc = ""
                        for mi_d in lists:
                            mc += "->" + mi_d + "\n"
                    ...
                    ki.sendMessage(to, "เจ BotSelfยังอยู่ครับ")
                elif text.lower() == 'เทส':
                    line.sendMessage(to, "เจ BotSelfกำลังโหลด:▒...0%")
                    ...
                    line.sendMessage(to, " 👍ถือว่าใช้ได้ครับท่าน MJ 👍")
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "ucd367347eb84b92850cd48393e63ba61")
                elif text.lower() == 'มิด':
                    ...
                    me = line.getContact(lineMID)
                    line.sendMessage(msg.to,"[สถานะที่แสดง]\n" + me.statusMessage)
#                elif text.lower() == 'ดิส':
#                    me = line.getContact(lineMID)
#                    line.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/" + me.pictureStatus)
                    ...
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        ...
                        for ls in lists:
                            contact = line.getContact(ls)
                            line.sendMessage(msg.to, "[ สถานะที่ตั่ง ]\n{}" + contact.statusMessage)
                    ...
                    try:
                        ...
                        line.sendMessage(msg.to, "กลับร่างเดิมสำเร็จ")
                    except:
                        line.sendMessage(msg.to, "กลับร่างเดิมแล้วครับ")
...
#==============================================================================#
                    ...
                    for target in targets:
                        try:
                            ...
                            line.sendMessage(msg.to,"เลียนแบบคนนี้แล้วแล้ว")
                            break
                        except:
                    ...
                    for target in targets:
                        try:
                            ...
                            line.sendMessage(msg.to,"ลบเลียนแบบคนนี้แล้ว")
                            break
                        except:
                    ...
                    if settings["mimic"]["target"] == {}:
                        line.sendMessage(msg.to,"เปิดระบบเลียบแบบแล้ว😝")
                    else:
                    ...
                    if mic == "on":
                        if settings["mimic"]["status"] == False:
                            ...
                            line.sendMessage(msg.to,"เปิดระบบเลียนแบบแล้วครับ")
                    elif mic == "off":
                        if settings["mimic"]["status"] == True:
                            settings["mimic"]["status"] = False
                            line.sendMessage(msg.to,"ปิดระบบเลียนแบบแล้วครับ")
#==============================================================================#
                elif text.lower() == 'แอด':
                    ...
                    ret_ += "\n╠ MIDกลุ่ม : {}".format(group.id)
                    ret_ += "\n╠ ประเภทกลุ่ม : {}".format(str(gCreator))
                    ret_ += "\n╠ จำนวนสมาชิก : {}".format(str(len(group.members)))
                    ret_ += "\n╠ จำนวนสมาชิกที่รอดำเนินการ : {}".format(gPending)
                    ret_ += "\n╠ Qr กลุ่ม : {}".format(gQr)
                    ...
                    line.sendMessage(msg.to,"ตั้งค่าสำเร็จ")
                    ...
                    if LINE != None:
                         ...
                         if spl[0] == "":
                            ...
                            if msg.toType == 2:
                                ...
                                num = int(strnum)
                                line.sendMessage(to, "เชิญเข้าร่วมการคอลเรียบร้อยแล้วครับ")
                    ...
                    line.sendMessage(msg.to,"เชิญเข้าร่วมการโทรสำเร็จแล้วครับ")	
                elif text.lower() == 'แทก':
                            if msg.toType == 0:
                                sendMention(to, to, "", "")
                            elif msg.toType == 2:
                ...
                elif "ยกเชิญ" in msg.text.lower():
                    spl = re.split("ยกเชิญ",msg.text,flags=re.IGNORECASE)
                    if spl[0] == "":
                        spl[1] = spl[1].strip()
                    ...
                    if GACReq.responseNum == 0:
                        if msg.toType != 0:
                                kk.sendText(msg.to,"ส่ง SMS สำเร็จแล้ว")
                        else:
                                kk.sendText(msg.from_,"ส่ง SMS สำเร็จแล้ว")
                    elif GACReq.responseNum == 1:
                        if msg.toType != 0:
                                kk.sendText(msg.to,"ไม่สามารถส่ง SMS ได้ เนื่องจากมีการส่งข้อความไปยังเบอร์เป้าหมายในเวลาที่ใกล้เคียงกันมากเกินไป \nกรุณารออย่างมาก 30 วินาทีแล้วลองอีกครั้ง")
                        else:
                                kk.sendText(msg.from_,"ไม่สามารถส่ง SMS ได้ เนื่องจากมีการส่งข้อความไปยังเบอร์เป้าหมายในเวลาที่ใกล้เคียงกันมากเกินไป \nกรุณารออย่างมาก 30 วินาทีแล้วลองอีกครั้ง")
                    else:
                        if msg.toType != 0:
                                kk.sendText(msg.to,"พบข้อผิดพลาดที่ไม่รู้จัก ")
                        else:
                                kk.sendText(msg.from_,"พบข้อผิดพลาดที่ไม่รู้จัก")
...
#==============================================================================#
                    ...
                    readTime = hasil + ", " + timeNow.strftime('%d') + " - " + bln + " - " + timeNow.strftime('%Y') + "\nระยะเวลา : [ " + timeNow.strftime('%H:%M:%S') + " ]"
                    if msg.to in read['readPoint']:
                        ...
                        with open('read.json', 'w') as fp:
                            json.dump(read, fp, sort_keys=True, indent=4)
                            line.sendMessage(msg.to, "ตั่งเวลา:\n" + readTime)
                    ...
                    if msg.to not in read['readPoint']:
                        ...
                        try:
                            ...
                            del read['readTime'][msg.to]
                              ...
                              pass
                        line.sendMessage(msg.to, "Delete เวลา:\n" + readTime)
                    ...
                    if msg.to in read["readPoint"]:
                        try:
                            ...
                            pass
                        line.sendMessage(msg.to, "Reset เวลา:\n" + readTime)
                    else:
                        line.sendMessage(msg.to, "ลบเวลาคนอ่านเรียบร้อยแล้ว")
...
#==============================================================================#   
                    ...
                    line.sendMessage(msg.to,"เปิดดูคนอ่านแล้ว")
                elif msg.text in ["ปิดอ่าน"]:
                    if msg.to in RfuCctv['point']:
                        RfuCctv['cyduk'][msg.to]=False
                        line.sendText(msg.to, RfuCctv['sidermem'][msg.to])
                    else:
                        line.sendMessage(msg.to, "ปิดดูคนอ่านแล้ว")
                    ...
                    line.sendMessage(msg.to, t1 + txt + t2)						
                        ...
                        line.sendMessage(msg.to,"กรุณาส่ง Contact คนที่ต้องการดึง")                            
...
#==============FINNISHING PROTECT========================#
                        ...
                        if settings["Lv"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"🔀เปิดข้อความต้อนรับเมื่อมีสมาชิกออกกลุ่ม   ")
                        else:
                            settings["Lv"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"🔀เปิดข้อความต้อนรับเมื่อมีสมาชิกออกกลุ่ม   ")
                        ...
                        if settings["Lv"] == False:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"❌ปิดข้อความต้อนรับเมื่อมีสมาชิกออกกลุ่ม   ")
                        else:
                            settings["Lv"] = False
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"❌ปิดข้อความต้อนรับเมื่อมีสมาชิกออกกลุ่ม   ")
...
#=======================================================================================
                    ...
                    if settings["changePictureProfile"] == True:
                        ...
                        line.sendMessage(to, "เปลี่ยนโปรไฟล์สำเร็จแล้วครับ")
                    if msg.toType == 2:
                        if to in settings["changeGroupPicture"]:
                            path = line.downloadObjectMsg(msg_id)
                            settings["changeGroupPicture"].remove(to)
                            line.updateGroupPicture(to, path)
                            line.sendMessage(to, "เปลี่ยนรูปกลุ่มสำเร็จแล้วครับ")
...
#==============================================================================#
        ...
        if op.type == 19:
            if op.param2 not in Family:
                ...
                elif text.lower().startswith('แอดมิน'):
                        MENTION = eval(msg.contentMetadata['MENTION'])
                        inkey = MENTION['MENTIONEES'][0]['M']
                        admin.append(str(inkey))
                        line.sendMessage(to, "เพิ่มสิทธิ์แล้ว！")
                elif text.lower().startswith('ลบแอดมิน'):
                        MENTION = eval(msg.contentMetadata['MENTION'])
                        inkey = MENTION['MENTIONEES'][0]['M']
                        admin.remove(str(inkey))
                        line.sendMessage(to, "ลบสิทธิ์แล้ว！")
                elif text.lower() == 'ตรวจสอบ':
                    if admin == []:
                        line.sendMessage(to, "ไม่มีอำนาจ")
                    else:
                        line.sendMessage(to, "ต่อไปนี้เป็นผู้ตรวจสอบ")
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["me","คท","Me",".คท","!me","/me"]:
                    line.sendText(msg.to,"เช็คทั้งวันทั้งคืนเลยหรอ555")
                if msg.text in ["speed","sp","Speed","สปีด","!speed","/speed"]:
                    line.sendText(msg.to,"แรงขนาดนี้ เจนี้กดไลค์เลย👍")
                if msg.text in ["กินข้าวยัง","กินข้าวยังทุกคน","กินข้าวกันยัง","กินข้าวกันยังทุกคน","กินข้าวยังค่ะ","กินข้างยังคับ","กินข้าวยังครับทุกคน"]:
                    line.sendText(msg.to,"ยังเลย รอคนมาป้อนอยู่!!.")
                if msg.text in ["555","5555","55555","55+","55++","555+","555++","5555+","5555++"]:
                    line.sendText(msg.to,"อาการหนักนะเนี๊ยมึง!!.เชิญรับยาช่อง2 อิอิ😝😝")				
                if msg.text in dangerMessage:
                    random.choice(Rfu).kickoutFromGroup(receiver,[sender])
                    random.choice(Rfu).sendText(msg.to,"ตรวจพบคำสั่งของบอทลบกลุ่ม  เจ Bot Self จำเป็นต้องนำออกเพื่อความปลอดภัยของสมาชิก")										
        if op.type == 17:
          if settings["Wc"] == True:
                ...
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        ...
                        if Name in RfuCctv['sidermem'][op.param1]:
                            ...
                            pref=['สวัสดีครับคนอ่าน➡','ตร๊ะ!..เอ๋!!..😝➡','หวัดดีจร้า💖➡','เจเห็นนะ อิอิ..😝➡','แอบทำมัย? มาคุยกันหน่อย➡','แอบแฟนเล่นหราา💨➡','เจรู้นะว่าคัยอ่าน👉➡','เล่นซ่อนแอบหรอคร้าบบ👻➡','มาคุยกับเค้าหน่อย➡','นั่นแน่ แอบหราาา➡']
