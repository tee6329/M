...
dangerMessage2 = ["ว่างัยจ๊ะทิรักของ5555","คร้าบบ","ว่างัยน่ะ!!.. รักหรออ อิอิ","ว่างัยเอ๋ยย รอฟังอยู่","มาแล้วคร้าบบ","แอบรักอยู่หราาา","แอบชอบหราา","รักหรอ","คิดถึงมากเลยหรอ"]
...
def listgrup():
    listGrup =  """💢คำสั่งตั้งค่า MJ BotSelf💢
...
def helpkicker():
    helpKicker = """⏳คำสั่งค้นหา MJ BotSelf⏳
...
def helpsetting():
    helpSetting = """⚓คำสั่งกลุ่ม MJ BotSelf⚓
📚 กลุ่ม ➠ ข้อมูลกลุ่ม
📚 ไอดีกลุ่ม ➠ไอดีห้อง
📚 ชื่อกลุ่ม ➠ ชื่อห้อง
...
def helptexttospeech():
    helpTextToSpeech =   """⚡คำสั่งเลียนแบบ MJ BotSelf⚡
💭 เลียนแบบ on/off 
💭 เลียนแบบ 
💭 เพิ่มเลียนแบบ (@) 
💭 ลบเลียนแบบ (@)"""
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    ki.sendMessage(to, "MJ BotSelfยังอยู่")
                elif text.lower() == 'เทส':
                    line.sendMessage(to, "MJ BotSelfกำลังโหลด:▒...0%")
                    ...
                    line.sendMessage(to, " 👍MJBotSelf ยังอยู่ครับท่าน✔")
                    ...
                    start = time.time()
                    line.sendMessage(to,"ความเร็วของ MJ Bot Self...")
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["speed","sp","Speed","สปีด","!speed","/speed"]:
                    line.sendText(msg.to,"แรงขนาดนี้ ไลค์เลย👍")
                ...
                if msg.text in ["555","5555","55555","55+","55++","555+","555++","5555+","5555++"]:
                    line.sendText(msg.to,"อาการหนักนะเนี๊ยมึง!!. อิอิ😝😝")				
                if msg.text in dangerMessage:
                    random.choice(Rfu).kickoutFromGroup(receiver,[sender])
                    random.choice(Rfu).sendText(msg.to,"ตรวจพบคำสั่งของบอทลบกลุ่ม  MJ&Bot Self จำเป็นต้องนำออกเพื่อความปลอดภัยของสมาชิก")										
        if op.type == 17:
          if settings["Wc"] == True:
                ...
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        ...
                        if Name in RfuCctv['sidermem'][op.param1]:
                            ...
                            pref=['สวัสดีจร้าคนอ่าน➡','ตร๊ะ!..เอ๋!!..😝➡','หวัดดีจร้า💖➡','เค้าเห็นนะ อิอิ..😝➡','แอบทำมัย? มาคุยกันหน่อย➡','แอบแฟนเล่นหราา💨➡','รู้นะว่าคัยอ่าน👉➡','เล่นซ่อนแอบหรอคร้าบบ👻➡','มาคุยกับเค้าหน่อย➡','นั่นแน่ แอบหราาา➡']
